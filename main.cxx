...
int main()
{
	initwindow(800, 600, "CHESS BOARD");


	setfillstyle(SOLID_FILL, RED);
	bar(450, 50, 500, 100);
	setcolor(WHITE);
	outtextxy(460, 70, "SAVE");

	setfillstyle(SOLID_FILL, GREEN);
	//x1,y1,x2,y2
	bar(450, 150, 500, 200);
	setcolor(WHITE);
	outtextxy(460, 170, "LOAD");

	setfillstyle(SOLID_FILL, BLUE);
	//x1,y1,x2,y2
	bar(450, 250, 500, 300);
	setcolor(WHITE);
	outtextxy(455, 270, "UNDO");

	setfillstyle(SOLID_FILL, YELLOW);
	//x1,y1,x2,y2
	bar(450, 350, 500, 400);
	setcolor(WHITE);
	outtextxy(455, 370, "REDO");
	...
	// bar(rdim*x1+10,cdim*y1+15,rdim*x1+40,cdim*y1+40);
...
//	circle(getmaxx()/2, getmaxy()/2, getmaxx()/2-10);
//	
//	setfillstyle(1, getmaxcolor()); 
////	bar3d(getmaxx() / 4-10, getmaxx() / 4, getmaxx() / 4 + 10, getmaxx() / 4 +10, 0, 0);
//	circle(getmaxx() / 4, getmaxy() / 4, getmaxx() / 12);
//
//	while (!kbhit())
//	{
//		
